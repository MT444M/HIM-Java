...
public class MA_App extends Application {
    @Override
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(MA_App.class.getResource("MarcheAleatoire.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        stage.setTitle("MarcheAleatoire!");
